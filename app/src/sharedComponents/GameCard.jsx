...
const GameCard = ({ code, gameId, playerNamesList, buttonLabel, buttonClickFunc, buttonColor }) => {
    return (
        <Card>
            <CardBody>
                <Container>
                    ...
                    {buttonLabel.length > 0 && gameId >= 0 && (
                        <Row>
                            <Col>
                                <div>
                                    <Button color={buttonColor} onClick={() => buttonClickFunc(gameId, code)}>
                                        {buttonLabel}
                                    </Button>
                                </div>
                            </Col>
