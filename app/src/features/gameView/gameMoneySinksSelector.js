...
const selectActiveGameMoneySinks = state => state.gamesData.activeGame.moneySinks;

export const selectActiveGameBankMoneySinkOnTop = createSelector(selectActiveGameMoneySinks, moneySinks => {
