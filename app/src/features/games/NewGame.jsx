...
class NewGame extends React.Component {
  ...
  handleSubmit = async () => {
    ...
    if (
      this.state.isCollectFromFreeParking !== false &&
      this.state.isCollectFromFreeParking !== true
    ) {
      isValid = false;
      this.setState({
  ...
  render() {
    return (
      <Container>
        <Row>
          <Col>
            <div className="glbl-heading">New Game</div>
          </Col>
        </Row>
          ...
          <Col mg="5">
            <Form>
              <FormGroup tag="fieldset">
                <Label>
                  Would you like to play a version of Monopoly where players
                  landing on Free Parking collect the money there?
                </Label>
                <FormGroup check>
                  <Input
                ...
                <FormGroup check>
                  ...
                  <FormFeedback>You must select either yes or no</FormFeedback>
                </FormGroup>
              </FormGroup>
